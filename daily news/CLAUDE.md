...
## Daily News workflow — read first

Before creating or editing a daily story, read
[`DAILY_NEWS_AGENT_GUIDE.md`](DAILY_NEWS_AGENT_GUIDE.md). It is the project
contract for research, image rights and relevance, copy limits, city targeting,
TTS generation, validation, and final rendering. Routine stories should change
story JSON and local assets, not the composition timing.
